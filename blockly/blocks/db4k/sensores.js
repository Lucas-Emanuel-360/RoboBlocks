...
Blockly.Blocks['sensor_linha'] = {
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown([[val_pouco, "POUCO"],[val_media, "MEDIA"],[val_muito, "MUITO"]]), "REFLEXO")
		.appendField("Reflexo: ")
        .appendField(new Blockly.FieldDropdown([[val_centro, "CENTRO"], [val_direito, "DIREITA"], [val_esquerdo, "ESQUERDA"]]), "DIRECAO");
